...
///string  url data
///enum with 3 cases - all 3 things are transferable
///inits that handles the cases - where one of the types is another types
enum Sturldata: Transferable {
    ...
    /// create a myself as a transferable by proxy
    /// transfer representation fro myself that is a proxy of these other formats
